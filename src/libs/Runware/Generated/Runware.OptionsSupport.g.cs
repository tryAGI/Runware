...
namespace Runware
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Runware.AutoSDKRetryOptions Retry { get; set; } = new global::Runware.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Runware.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Runware.IAutoSDKHook>();
        ...
        public global::Runware.AutoSDKClientOptions AddHook(
            global::Runware.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Runware.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Runware.AutoSDKClientOptions UseAuthorizationProvider(
            global::Runware.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Runware.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Runware.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Runware.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Runware.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Runware.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Runware.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Runware.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Runware.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Runware.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Runware.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Runware.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Runware.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Runware.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Runware.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Runware.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Runware.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Runware.AutoSDKClientOptions clientOptions,
            global::Runware.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Runware.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Runware.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Runware.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Runware.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Runware.IAutoSDKHook, global::Runware.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Runware.AutoSDKHookContext context)
        {

...
namespace Runware
{
    ...
    public sealed class AutoSDKConditionalResponse<T>
    {
        internal AutoSDKConditionalResponse(
            bool notModified,
            string? entityTag,
            global::Runware.AutoSDKHttpResponse<T>? response)
        {
        ...
        public global::Runware.AutoSDKHttpResponse<T>? Response { get; }
    }
    ...
    public static class AutoSDKConditionalRequests
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.Task<global::Runware.AutoSDKConditionalResponse<T>> SendAsync<T>(
            global::System.Func<global::Runware.AutoSDKRequestOptions, global::System.Threading.CancellationToken, global::System.Threading.Tasks.Task<global::Runware.AutoSDKHttpResponse<T>>> send,
            string? entityTag = null,
            global::Runware.AutoSDKRequestOptions? requestOptions = null,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new global::Runware.AutoSDKConditionalResponse<T>(
                    notModified: false,
                    entityTag: GetEntityTag(response.Headers),
                    response: response);
            }
            catch (global::Runware.ApiException exception)
        ...
        private static global::Runware.AutoSDKRequestOptions CloneRequestOptions(
            global::Runware.AutoSDKRequestOptions? source)
        {
            var clone = new global::Runware.AutoSDKRequestOptions();
            if (source == null)
            {
                return clone;
            }
